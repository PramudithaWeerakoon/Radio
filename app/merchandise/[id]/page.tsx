...
const product = {
  ...
  price: 29.99,
  description: "Our iconic band logo t-shirt, crafted from 100% organic cotton for ultimate comfort and style. Features the Midnight Echo emblem in high-quality screen printing that stands the test of time.",
  images: [
